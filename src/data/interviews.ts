...
export const INTERVIEWS: Interview[] = [
  {
    ...
    career:
      '大学では社会学を専攻し、フィールドワークで中小企業の事業承継を研究。「現場に入り込んで課題を解く仕事がしたい」と2024年に新卒入社。1年目から製造業クライアントのDXプロジェクトに参画し、データ分析と現場ヒアリングを担当。現在は小売クライアントの戦略チームで市場分析を担う。',
    qa: [
      {
        ...
        paragraphs: [
          ...
          'もちろん、意見を求められるのはプレッシャーでもあります。でも「問われ続ける」からこそ、常に自分の頭で考える癖がつきました。この1年で、学生時代の自分とは別人になったと思います。',
        ],
  ...
  },
  {
    ...
    career:
      '大手SIerで5年間、基幹システムの開発と運用に従事。「作って終わり」ではなく事業の成果まで踏み込みたいと考え、2023年にアイシンへ中途入社。DX支援プロジェクトを中心に、データ基盤構築から業務再設計までを一気通貫で担当。現在は複数プロジェクトのリードを務める。',
    qa: [
      {
  ...
  },
  {
    ...
    career:
      '広告代理店でプランナーとして4年間勤務した後、2021年にアイシンへ中途入社。新規事業開発チームで複数の0→1プロジェクトを推進し、29歳で最年少マネージャーに昇格。現在は3つのプロジェクトを統括しながら、採用と育成にも携わる。',
    qa: [
      {
